...
class TeamMembersView(APIView):
    ...
    def get(self, request):
        slider = TeamMembers.objects.all().order_by("-id")[0:4]
        slid = TeamMembersSerializer(slider, many=True)
        return Response(slid.data)
...
class AboutUsView(APIView):
    ...
    def get(self, request):
        slider = AboutUs.objects.last()
        slid = AboutUsSerializer(slider)
        return Response(slid.data)
